...
<main>
    ...
    <h2>Create report for:  ${sessionScope.testBuilding.buildingName}<br>
        Adress: ${sessionScope.testBuilding.streetAddress} ${sessionScope.testBuilding.streetNumber}<br>
        Zip Code: ${sessionScope.testBuilding.zipCode}</h2>
            ...
            <div class="w3-row-padding">
                <div class="w3-half w3-row-padding">
                    ...
                    <c:forEach var="i" begin="0" end="${requestScope.numOfRooms}" varStatus="count">
                        ...
                        <div class="w3-container w3-blue">
                            <h3>Room Interior Inspection</h3>
                            ...
                            <div class="w3-threequarter"><label class="w3-label w3-text-black"><b>Remarks for floor?</b></label>
                            ...
                            <div class="w3-threequarter"><label class="w3-label w3-text-black">Add picture</label><input type="file" name="" value="" class="w3-input w3-border"/></div>
                             ...
                             <div class="w3-container w3-blue">
                            <h3>Is there a damage to the room?</h3>
                        ...
                        <div class="w3-container w3-blue">
                            ...
                            <div class="w3-threequarter"><label class="w3-label w3-text-black"><b>Measure location</b></label>
